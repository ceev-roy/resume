  ...
  return (
    <div className='space-y-4'>
      ...
      <div className='flex gap-2'>
        <input value={newSkill} onChange={(e) => setNewSkill(e.target.value)} onKeyDown={handleKeyPress} type="text" placeholder='Add a skill (e.g. JavaScript, Project Management)' className='flex-grow px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring focus:ring-blue-500 focus:border-blue-500 outline-none transition-colors' />
      ...
      <div className='bg-purple-50 p-3 rounded-lg'>
        <p className='text-sm text-purple-800'><strong>Tip:</strong>Add 8-12 relevant skills. Include both technical skills (programming languages, tools) and soft skills (communication, leadership).</p>
      </div>
    </div>
  )
}
