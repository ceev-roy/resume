...
const CallToAction = () => {
  return (
    <div id='cta' className='scroll-mt-12 mt-28'>
      <style>{`
            ...
            `}</style>
      <section className="flex flex-col items-center justify-center mx-auto max-md:mx-2 max-md:px-2 max-w-5xl w-full text-center rounded-2xl py-16 bg-green-100/10">

        <h1 className="text-2xl md:text-3xl font-medium text-slate-900 max-w-2xl mt-2">
          Build Your First Resume With Us.
        </h1>
        <p className="text-sm text-gray-500 max-w-lg mt-2">
          resumes. gives you ready-to-use resume so you can edit and live stunning links to your resume quickly, without starting from scratch.
        </p>
